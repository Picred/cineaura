...
import { loginStore, useRegisterAction } from "../redux/user.store";
...
//     const risultato = registerAction({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    auth
      ...
      .then(() => {
        ...
        navigate("/"); // Naviga alla home page o a un'altra pagina dopo il successo
      })
      .catch((error) => {
        toast.error(error, {
          position: "bottom-right",
        ...
        // Mostra un messaggio di errore all'utente, ad esempio tramite una notifica
      });
  };
